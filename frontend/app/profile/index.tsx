...
export default function ProfileScreen() {
  console.log('ProfileScreen: Component rendering started');
  
  try {
    const dispatch = useDispatch();
    const { user, isAuthenticated } = useSelector((state: RootState) => state.auth);
    
    console.log('ProfileScreen: Redux state - user:', user);
    console.log('ProfileScreen: Redux state - isAuthenticated:', isAuthenticated);
    
    // Skip API calls for now to test basic rendering
    const debtsData = [];
    const budgetData = null;
    const debtsLoading = false;
    const budgetLoading = false;
    const debtsError = null;
    const budgetError = null;
    ...
    console.log('ProfileScreen: About to render main content');
    ...
    if (debtsError || budgetError) {
      console.log('ProfileScreen: Showing error state');
      return (
        <View style={styles.container}>
          <StatusBar barStyle="dark-content" backgroundColor={COLORS.white} />
    ...
    if (loading) {
      console.log('ProfileScreen: Showing loading state for actions');
      return (
        <View style={styles.loadingContainer}>
          <ActivityIndicator size="large" color={COLORS.primary} />
    ...
    if (!isAuthenticated) {
      console.log('ProfileScreen: User not authenticated, showing auth prompt');
      return (
        <View style={styles.container}>
          <StatusBar barStyle="dark-content" backgroundColor={COLORS.white} />
    ...
    console.log('ProfileScreen: Rendering main profile content');
    return (
      <View style={styles.container}>
        <StatusBar barStyle="dark-content" backgroundColor={COLORS.white} />
        {/* Header */}
